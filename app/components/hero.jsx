        ...
        <div className=" w-full max-w-[95vw]  bg-blue-600 rounded-lg border-2 border-black-700 p-1 mt-5">
          ...
          <div className="  justify-center  text-center mt-10 md:mt-40  ">
            ...
            <div className="grid md:grid-cols-2 p-2 ">
              <div>
               <h1 className=" md:mt-10 md:mb-10 mb-5  text-6xl scale-y-150 md:text-8xl lg:text-[12vw] font-figtree font-black text-[#F7FD06] [-webkit-text-stroke:1.5px_#000000] md:[-webkit-text-stroke:4px_#000000]  ">
                 WHAT'S <br />GOOD!
               </h1>
